...
const int RIGHT_CALIBRATION = 170;
...
const int TURN_THRESHOLD_SS90E = 92 * 2;
...
const float WHEEL_DIAMETER = 30.93;
...
const float MOUSE_RADIUS = 40.7;  // 39.50; // Adjust on test
...
const float ROTATION_BIAS = 0.00;  // Negative makes robot curve to left
